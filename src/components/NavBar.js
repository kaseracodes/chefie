...
export const NavBar = () => {
  ...
  function handleClick(){
    window.open('https://forms.gle/2VhgBxrQM6MdJoUf9', '_blank');
  }
  ...
  return (
    <Router>
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="/">
            Chefie<span id = "buddy"> Services</span>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" id = "link3" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>About us</Nav.Link>
              </div>
            </Nav>
